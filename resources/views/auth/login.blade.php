...
<head>
    ...
    <title>Logowanie - {{ config('app.name', 'Rehamed') }}</title>
                ...
                <div class="lg:w-1/2 hero-gradient p-12 flex flex-col justify-center items-center text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10 text-center animate-fadeInUp">
                        ...
                        <p class="text-xl mb-8 text-purple-100">
                            Nowoczesna platforma rehabilitacji medycznej
                        </p>
                        ...
                        <div class="space-y-4 text-left max-w-sm mx-auto">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-lg">Łatwe zarządzanie wizytami</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="shrink-0 w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-file-medical text-xl"></i>
                                </div>
                                <span class="text-lg">Dokumentacja medyczna online</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="shrink-0 w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-comments text-xl"></i>
                                </div>
                                <span class="text-lg">Bezpośredni kontakt z lekarzem</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="max-w-md mx-auto w-full animate-fadeInUp">
                        ...
                        @if ($errors->any())
                            <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <h3 class="text-red-800 font-semibold mb-1">Błąd logowania</h3>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-sm font-medium gradient-text hover:underline">
                                        Zapomniałeś hasła?
                                    </a>
                                @endif
                            </div>
                        ...
                        @if (Route::has('register'))
                            <div class="mt-8 text-center">
                                <p class="text-gray-600">
                                    Nie masz konta?
                                    <a href="{{ route('register') }}" class="font-semibold gradient-text hover:underline ml-1">
