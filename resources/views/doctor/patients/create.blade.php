...
<div class="flex-1 p-6">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Dodaj nowego pacjenta</h1>
                <p class="text-gray-600">Utwórz konto dla nowego pacjenta w systemie.</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="p-6 text-center">
                    ...
                    <div class="mb-6">
                        <img id="avatar-preview"
                             src="https://ui-avatars.com/api/?name=N+P&size=200&background=10b981&color=ffffff&bold=true&rounded=true"
                             alt="Podgląd awatara"
        ...
        <div class="lg:col-span-2">
            <!-- Form -->
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                <form id="patient-form" method="POST" action="{{ route('doctor.patients.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="address"
                                          ...
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('address') @enderror">{{ old('address') }}</textarea>
                                @error('address')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="border-t border-gray-200">
                        ...
                        <div class="px-6 pb-6 pt-6">
                            ...
                            <!-- Info about auto-activation -->
                            <div class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                                <div class="flex items-center">
                                    <i class="fas fa-info-circle text-green-600 mr-2"></i>
                                    <div class="text-sm text-green-800">
                                        <strong>Automatyczna aktywacja:</strong> Konto pacjenta zostanie automatycznie aktywowane i zweryfikowane po utworzeniu.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="px-6 pb-6 pt-6">
                            <div>
                                ...
                                <textarea id="medical_history"
                                          ...
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('medical_history') @enderror">{{ old('medical_history') }}</textarea>
...
<script>
    ...
    function updateAvatarPreview() {
        ...
        // Only update if no custom image is selected
        const avatarInput = document.getElementById('avatar-input');
        if (!avatarInput.files || avatarInput.files.length === 0) {
            let initials = 'N P';
            if (firstname || lastname) {
                const firstInitial = firstname ? firstname.charAt(0).toUpperCase() : 'N';
                const lastInitial = lastname ? lastname.charAt(0).toUpperCase() : 'P';
                initials = firstInitial + ' ' + lastInitial;
            }

            // Use green color for patients
